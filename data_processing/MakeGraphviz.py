...
class GraphvizDiagramGenerator(object):
    ...
    def setGraphicOptions(self, greyFlag=None, splinevar=None):
        ...
        self.__log__('setGraphicOption: updated greyFlag = ' + str(self.greyFlag) +
                     ' and splinevar = ' + str(self.colors['splinevar']))
    ...
    def CreateCommodityPartialResults(self, period, region, comm, outputFormat='svg'):
        ...
        input_total = set(self.dbUtil.getExistingTechnologiesForCommodity(
            comm, region, 'output')['tech'])
        output_total = set(self.dbUtil.getExistingTechnologiesForCommodity(
            comm, region, 'input')['tech'])
