...
def db_2_dat(ifile, ofile, options):
    ...
    table_list = [
        ...
        ['param', 'MinSeasonalCapacityFactor', '',                    '',             4],
        ['param', 'MaxSeasonalCapacityFactor', '',                    '',             4],
        ...
        ['param', 'MaxNewCapacityGroupShare',  '',                    '',             4],
        ['param', 'MinNewCapacityGroupShare',  '',                    '',             4],
